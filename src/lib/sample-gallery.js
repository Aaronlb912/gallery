  ...
  items: [
    {
      ...
      title: 'Wide bowl',
      caption: 'Ash over iron. Thrown on Tuesday.',
      credit: 'Nia Brooks, nia@example.com',
      date: '2026-09-12',
    },
    {
      id: 'p-vase',
      ...
      title: 'Bottle vase',
      caption: 'Tenmoku. Evening firing.',
      credit: 'Jules Nguyen',
      date: '2026-09-10',
    },
    {
      ...
      title: 'Mug',
      caption: 'Celadon lip. For the shop shelf.',
      credit: 'Pat Ortiz',
      date: '2026-09-14',
    },
    {
      ...
      title: 'Lidded jar',
      caption: 'Shino. Tight lid.',
      credit: 'Mira Patel, mira@example.com',
      date: '2026-09-08',
    },
  ],
}

export const sampleEmptyGallery = {
  id: 'gallery-bisque',
  title: 'Bisque waiting',
  note: 'Shelf by the kiln. Add a photo, or drop one here.',
  items: [],
}

export const sampleWorkspace = {
  galleries: [sampleGallery, sampleEmptyGallery],
  activeGalleryId: 'gallery-mill-street',
}
